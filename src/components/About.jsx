  ...
  <section id="about" className="mx-auto max-w-3xl px-4 py-24 scroll-mt-20">
    ...
    <div className="prose-block space-y-6 leading-relaxed">
      <p>
        ...
        I am looking for full-time opportunities in Software Engineering or Backend Engineering where I can apply my skills and continue to grow as a developer.
        The technologies I am most experienced with are{" "}
        <InlineCode>Python</InlineCode>, <InlineCode>Java</InlineCode>,
      ...
      <p>
        ...
        I also really enjoy exploring new places and going on adventures.
